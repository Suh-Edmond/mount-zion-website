    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('manage.academics')"
                        :active="request()->is('*/manage.academics/*') || request()->routeIs('manage.academics')">
                        {{ __('Academics') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('manage.events')"
                        :active="request()->is('*/manage.events/*') || request()->routeIs('manage.events')">
                        {{ __('Events') }}
                    </x-nav-link>
                </div>
            </div>
