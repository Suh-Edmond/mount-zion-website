<x-mail::message>
    ...
    the {{\Carbon\Carbon::parse($program->getCurrentAdmissionSession($program)->start_date
    ?? '')->format('M Y')}}. This year, we received a large number of highly qualified applicants, and the selection
    process was
