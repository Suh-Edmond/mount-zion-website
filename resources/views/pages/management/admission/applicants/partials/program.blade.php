<section >
    ...
    <div class="my-4 flex space-x-3">
        <i class="fa fa-home "></i><x-input-label for="name" :value="__('School : ')"   style="font-size:medium"/>
        <x-input-label for="name" class="font-semibold text-gray-900" value="{{$applicant->program->school->name}}" style="font-size: medium" />
    </div>

    <div class="my-4 flex space-x-3">
        <i class="fa fa-book "></i><x-input-label for="name" :value="__('Applied Program : ')"   style="font-size:medium"/>
        <x-input-label for="name" class="font-semibold text-gray-900" value="{{$applicant->program->name}}" style="font-size: medium" />
    </div>

    <div class="my-4 flex space-x-3">
        <i class="fa fa-clock-o "></i><x-input-label for="name" :value="__('Duration : ')"   style="font-size:medium"/>
        <x-input-label for="name" class="font-semibold text-gray-900" value="{{$applicant->program->duration}}" style="font-size: medium" />
    </div>
    <div class="my-4 flex space-x-3">
        <i class="fa fa-book "></i><x-input-label for="name" :value="__('Program Type : ')"   style="font-size:medium"/>
        <x-input-label for="name" class="font-semibold text-gray-900" value="{{$applicant->program->tag}}" style="font-size: medium" />
    </div>

    <div class="my-4 flex space-x-3">
        <i class="fa fa-calendar fa-xs "></i><x-input-label for="name" style="font-size:medium" :value="__('Admission Year : ')" />
    ...
    <div class="my-4 flex space-x-3">
        @if($applicant->applicant_status === \App\Constant\AdmissionStatus::UNDER_REVIEW)
         <i class="fa fa-calendar-check-o fa-xs "></i><x-input-label for="name" :value="__('Application Status : ')"   style="font-size:medium"/>
        ...
        <i class="fa fa-check-circle-o fa-xs "></i><x-input-label for="name" :value="__('Application Status : ')"   style="font-size:medium"/>
            <x-input-label for="name" class="font-semibold text-green-700" value="{{$applicant->applicant_status}}" style="font-size: medium"/>
        @else
        <i class="fa fa-times fa-xs "></i><x-input-label for="name" :value="__('Application Status : ')"   style="font-size:medium"/>
