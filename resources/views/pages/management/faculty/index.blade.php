    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{route('manage.academics.create')}}">
                <x-primary-button
                >{{ __('Create Faculty') }}</x-primary-button>
            </a>
        </div>
    </x-slot>
