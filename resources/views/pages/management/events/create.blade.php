                ...
                <form method="post"
                    ...
                    <div class="flex gap-8">
                        <div class="grow my-4">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->first('location')" />
                        </div>
                        <div class="grow my-4">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->first('venue')" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-x-8">
                        <div class="grow my-4">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->first('phone')" />
                        </div>
                        <div class="grow my-4">
                        ...
                        <div class="grow mt-4">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->first('website')" />
                        </div>
                    </div>
                    ...
                    <div class="flex gap-8">
                        <div class="grow my-4">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->first('event_date')" />
                        </div>
                        <div class="grow my-4">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->first('event_time')" />
                        </div>
                    </div>
