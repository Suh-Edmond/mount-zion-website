                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-cat-item">
                            <div class="cat-thumb">
                                ...
                                <a href="{{ route('main.schools.program.show', ['programSlug' => $program->slug, 'schoolSlug' => $program->school->slug]) }}"
                                    class="cat-link-btn">{{ $program->tag }}</a>
                            </div>
                            <div class="cat-meta">
                                <div class="cat-title">
                                    <a
                                        href="{{ route('main.schools.program.show', ['programSlug' => $program->slug, 'schoolSlug' => $program->school->slug]) }}">{{
                                        $program->name }}</a>
                                </div>
                                <div class="cat-link">
                                    <a href="{{ route('main.schools.program.show', ['programSlug' => $program->slug, 'schoolSlug' => $program->school->slug]) }}"
                                        class="cat-link-arrow"><i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    // document.getElementsByClassName('program-type-filter').addEventListener('change', function() {
    //     document.getElementById('loader').style.display = 'flex';
    // });
</script>