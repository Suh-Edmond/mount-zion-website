            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="rts-slider-height rts-slider-overlay rt-relative ">
                        <div class="rts-slider-bg" data-background="assets/images/hero/slider__1.jpg"
                            style="background-image: url(assets/images/hero/slider__1.jpg);"></div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-xl-6 col-md-8 col-sm-9">
                                    <div class="rts-slider">
                                        <div class="rts-slider-content">
                                            <h6 class="rts-subtitle"><img src="assets/images/icon/e-cap.svg"
                                                    alt="education hat"> excellence in healthcare education</h6>
                                            <h1 class="rts-slider-title">
                                                Mount Zion Clinic
                                                Advancing Healthcare
                                            </h1>
                                            <div class="rts-slider-btn">
                                                <a href="{{ route('main.clinic') }}"
                                                    class="rts-theme-btn btn-arrow">View Our Services <span><i
                ...
                <div class="swiper-slide">
                    <div class="rts-slider-height rts-slider-overlay rt-relative ">
                        <div class="rts-slider-bg" data-background="assets/images/hero/slider__2.jpg"
                            style="background-image: url(assets/images/hero/slider__2.jpg);"></div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-xl-6 col-md-8 col-sm-9">
                                    <div class="rts-slider">
                                        <div class="rts-slider-content">
                                            ...
                                            <div class="rts-slider-btn">
                                                <a href="{{ route('main.programs') }}"
                                                    class="rts-theme-btn btn-arrow">View Our Programs <span><i
                                                            class="fa-thin fa-arrow-right"></i></span></a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-6">
                    <div class="rts-left-section">
                        ...
                        <div class="left-section-content">
                            <p>
                                Mount Zion Clinic is a leading medical facility in Bamenda, Cameroon, committed to
                                delivering compassionate, high-quality, and affordable healthcare to over 300,000
                                residents in the region. Since our founding in September 1992, we have grown into a
                                trusted institution known for integrity, professionalism, and holistic care.
                            </p>
                            <p>
                            ...
                            <a href="{{ route('main.clinic') }}" class="rts-theme-btn primary btn-arrow">Read
                                More<span><i class="fa-thin fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-5">
                    <div class="rts__section--wrapper v__2">
                        ...
                        <p class="rts__section--description">
                            Mount Zion is dedicated to delivering modern, high-quality education in health sciences,
                            grounded in ethics, integrity, and compassionate care. We empower students with practical,
                            up-to-date knowledge to serve communities and advance global healthcare. Our goal is to
                            become a sustainable, world-class institution through excellence in learning, innovation,
                            and service.
                        </p>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-6 col-md-6">
                            <div class="program__content">
                                <div class="rts__program--item v__2"
                                    style="background-image: url(assets/images/home/procession.jpg);">
                                    <h5 class="rts__program--item--title">Special Care Nursing Program</h5>
                                    <p class="rts__program--item--description">Begin your journey to becoming a Health
                                        Care Assistant at MZHI through our one-year program.</p>
                                    <a href="{{ route('main.academic-area') }}" class="rts-nbg-btn btn-arrow">Learn
                                ...
                                <!-- second one -->
                                <div class="rts__program--item v__2"
                                    style="background-image: url(assets/images/home/classroom_1.jpg);">
                                    <h5 class="rts__program--item--title">HND Program</h5>
                                    <p class="rts__program--item--description">Build a strong foundation for your
                                        career in healthcare through MZHI’s HND program.</p>
                                    <a href="{{ route('main.academic-area') }}" class="rts-nbg-btn btn-arrow">Learn
                                        More<span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                                        </span></a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="program__content mt--85">
                                <div class="rts__program--item v__2"
                                    style="background-image: url(assets/images/home/demonstration.jpg);">
                                    <h5 class="rts__program--item--title">Bsc Program</h5>
                                    <p class="rts__program--item--description">Shape a meaningful career in healthcare
                                        with MZHI’s BSc program.</p>
                                    <a href="{{ route('main.academic-area') }}" class="rts-nbg-btn btn-arrow">Learn
                                        More<span><i class="fa-sharp fa-regular fa-arrow-right"></i>
                                        </span></a>
            ...
            <div class="row justify-content-sm-center justify-content-lg-start">
                <div class="col-lg-6 col-xl-5 col-md-10 col-sm-11">
                    <div class="rts-left-section">
                        ...
                        <a href="{{ route('main.donate') }}"
                            class="about-btn rts-nbg-btn btn-arrow
                    rt-white">Learn More <span><i
                ...
                <div class="col-lg-6 col-xl-7 col-md-10 col-sm-11">
                    <div class="rts-right-section rt-relative">
                        <p class="rt-white mb--40">
                            To be recognized as a global leader in higher education, research, and innovation, committed
                            to excellence and dedicated to meeting the aspirations of the international community.
                        </p>
                ...
                @foreach ($schools as $school)
                    <div class="col-lg-6 col-md-6">
                        <div class="blog__single--item">
                            <a href="{{ route('main.schools.show', $school->slug) }}"
                                class="blog__single--item--link">
                    ...
                    "breakpoints":{
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="single-brand-logo">
                                    <a href="{{ route('main.about') }}">
                                        <img src="assets/images/partners/partner_3.png" alt="" width="100px"
                                            height="100px">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="single-brand-logo">
                                    <a href="{{ route('main.about') }}">
                                        <img src="assets/images/partners/partner_1.jpg" alt="" width="100px"
                                            height="100px">
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="single-brand-logo">
                                    <a href="{{ route('main.about') }}">
                                        <img src="assets/images/partners/partner_2.jpg" alt="" width="100px"
                                            height="100px">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="rts-program-single">
                        <div class="rts-program-single__content">
                            <div class="rts-program-hover">
                                ...
                                <a href="{{ route('main.academic-area') }}" class="program-link">Special Care
                                    Nursing</a>
                                <p>Embark on a journey of knowledge, discovery, and growth at Mount Zion Higher
                                    Institute.</p>
                                <a href="{{ route('main.academic-area') }}"
                                    class="about-btn rts-nbg-btn btn-arrow
rt-white before-white">View Program <span><i
                                            class="fa-sharp fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rts-program-single">
                        <div class="rts-program-single__content">
                            <div class="rts-program-hover">
                                ...
                                <a href="{{ route('main.academic-area') }}" class="program-link">Bachelor's
                                    Program</a>
                                <p>Empower yourself with the skills to heal and lead at Mount Zion Higher Institute</p>
                                <a href="{{ route('main.academic-area') }}"
                                    class="about-btn rts-nbg-btn btn-arrow
rt-white before-white">Visit Program
                    ...
                    <div class="col-lg-7 col-md-11">
                        <div class="research-content-area">
                            ...
                            <div class="research-meta-info mt--50 mb--70">
                                <a href="{{ route('main.contact') }}" class="rts-theme-btn btn-arrow">Join
                                    Community<span><i class="fa-thin fa-arrow-right"></i></span></a>
                                <div class="research-author">
                                    <div class="image">
                                        <img src="assets/images/about/dr_atem_1.jpg" alt="author" width="50px"
                                            height="50px" style="border: 50%">
                                    </div>
                                    <div class="info">
                                        <h6>Dr. Atem Paul</h6>
                                        <p>The CEO</p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="rts-scholarship-info">
                        ...
                        <a href="{{ route('main.donate') }}" class="rts-theme-btn btn-arrow">Donate Now<span><i
                                    class="fa-thin fa-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
